...
Step 10 - If any case fail in step 9 condition u need to add in report also and test case should fail with proper error message including request and response details.
